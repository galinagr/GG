...
public class BookingComAPI_Mod7 implements API_Mod7 {
       private List<Room> rooms = new ArrayList<>();


    public BookingComAPI_Mod7() {

        rooms.add(new Room(1001, 200, "Kyiv", 2, Date.from(Instant.parse("12-04-2016")), "Avrora"));

        rooms.add(new Room(1001, 200, "Kyiv", 2, Date.from(Instant.parse("12-04-2016")), "Sputnik"));
